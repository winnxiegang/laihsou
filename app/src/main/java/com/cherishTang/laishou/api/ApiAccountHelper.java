...
/**
 * Created by 方舟 on 2017/8/18.
 * 存放应用相关常见
 */

public class ApiAccountHelper {
    public static final String TOKEN_DATA = UserAccountHelper.APPNAME+"_TOKEN_DATA";
    public static final String TOKEN_DATA_STRING = UserAccountHelper.APPNAME+"_TOKEN_DATA_STRING";
    //项目appkey
    public static  final  String APPPKEY_LOWCASE = "3180787a569c4879aaa0dccd9621cb77";
    public static  final  String APPKAY_UPCASE = APPPKEY_LOWCASE.toUpperCase();
