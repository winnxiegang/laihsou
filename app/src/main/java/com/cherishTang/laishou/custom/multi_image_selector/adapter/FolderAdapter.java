package com.cherishTang.laishou.custom.multi_image_selector.adapter;
...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context){
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.x144);
    }
                ...
                if(mFolders.size()>0){
                    ...
                    if (f != null) {
                        Picasso.with(mContext)
                                ...
                                .resizeDimen(R.dimen.x144, R.dimen.x144)
                                .centerCrop()
                                .into(holder.cover);
                    }else{
