...
public class HeadThreeAdapter extends BaseQuickAdapter<CircleThreeLeiBean.DataBean.ListBean, BaseViewHolder> {
    public HeadThreeAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(BaseViewHolder helper, CircleThreeLeiBean.DataBean.ListBean item) {
        ...
        Glide.with(mContext)
                ...
                .dontAnimate()
                .into(imageView);
        helper.getView(R.id.head_three_detal).setOnClickListener(new View.OnClickListener() {
            @Override
