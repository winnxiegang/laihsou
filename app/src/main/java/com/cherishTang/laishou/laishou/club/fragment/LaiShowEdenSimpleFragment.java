...
public class LaiShowEdenSimpleFragment extends BaseViewPagerFragment {
    ...
    protected PagerInfo[] getPagers() {
        ...
        infoList[0] = new PagerInfo("综合", LaiShowEdenFragment.class, getBundle(1));
        infoList[1] = new PagerInfo("按人气", LaiShowEdenFragment.class, getBundle(2));
        infoList[2] = new PagerInfo("按会员数", LaiShowEdenFragment.class, getBundle(3));
        infoList[3] = new PagerInfo("按距离来", LaiShowEdenFragment.class, getBundle(4));
        return infoList;
    }
...
//                    startActivity(intent);
    ...
    public static Fragment instantiate(Bundle bundle) {
        Fragment fragment = new LaiShowEdenSimpleFragment();
