 ...
 * 莱瘦圈
 */
public class ChangPinRecommendAdapter extends BaseRecyclerViewAdapter<ComListBean.DataBean.SpellGoodsListBean> {

    public ChangPinRecommendAdapter(Context mContext) {
        super(mContext);
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD && getHeaderView() != null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.changpin_recommend_list_item, parent, false);
        }
    ...
    public void onBindViewHolder(final BaseViewHolder viewHolder, final int position) {
        ...
        holder.tvArticleTitle.setText(mList.get(pos).getGoodsName());
        Glide.with(mContext)
