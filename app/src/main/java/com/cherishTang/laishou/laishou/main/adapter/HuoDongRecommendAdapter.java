 ...
 * 莱瘦圈
 */
public class HuoDongRecommendAdapter extends BaseRecyclerViewAdapter<ComListBean.DataBean.ActivityListBean> {

    public HuoDongRecommendAdapter(Context mContext) {
        super(mContext);
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD && getHeaderView() != null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.huodong_recommend_list_item, parent, false);
        }
    ...
    public void onBindViewHolder(final BaseViewHolder viewHolder, final int position) {
        ...
        holder.tvArticleTitle.setText(mList.get(pos).getActivityTitle());
        Glide.with(mContext)
