 ...
 * 莱瘦圈
 */
public class LaiShowAdapter extends BaseRecyclerViewAdapter<ArticleBean> {

    public LaiShowAdapter(Context mContext) {
        super(mContext);
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD && getHeaderView() != null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.laishou_list_item, parent, false);
        }
