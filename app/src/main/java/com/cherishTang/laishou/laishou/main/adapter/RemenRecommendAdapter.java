 ...
 * 莱瘦圈
 */
public class RemenRecommendAdapter extends BaseRecyclerViewAdapter<ComListBean.DataBean.HotListBean> {

    public RemenRecommendAdapter(Context mContext) {
        super(mContext);
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEAD && getHeaderView() != null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.remen_recommend_list_item, parent, false);
        }
