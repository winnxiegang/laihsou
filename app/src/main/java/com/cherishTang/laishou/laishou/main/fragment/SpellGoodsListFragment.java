...
public class SpellGoodsListFragment extends BaseRecyclerViewFragment<SpellGoodsBean> implements View.OnClickListener {
    ...
    protected BaseRecyclerViewAdapter<SpellGoodsBean> getRecyclerAdapter() {
        ...
        if (!isHideHeadView) {
            ...
            customHot.setOnClickListener(this);
            customDiscount.setOnClickListener(this);
            customJmhf.setOnClickListener(this);
            customSjsm.setOnClickListener(this);
            customCloth.setOnClickListener(this);
    ...
    public static Fragment instantiate(Bundle bundle) {
        Fragment fragment = new SpellGoodsListFragment();
