...
import com.cherishTang.laishou.laishou.main.bean.MainLaiShowListBean2;
...
public class VedioListFragment extends BaseRecyclerViewFragment<ArticleBean> {
    ...
    protected void requestData() {
        super.requestData();
        ApiHttpClient.getArticlePage(new Gson().toJson(new MainLaiShowListBean2(mCurrentPage, ConstantsHelper.indexShowPages, UserAccountHelper.getLocalSubstation().getId(), 3)), this, stringCallback);
    }
