 ...
 * describe:scrollview是否滑动到顶部或底部
 */
public class CustomScrollView extends ScrollView {
    //回调监听接口
    private OnScrollEndChangeListener mOnScrollChangeListener;
    //标识是否滑动到顶部
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        mOnScrollChangeListener.onScrolling();
    ...
    //滑动监听接口
    public interface OnScrollEndChangeListener {
        //滑动到顶部时的回调
    ...
    public void setOnScrollEndChangeListener(OnScrollEndChangeListener onScrollChangeListener) {
