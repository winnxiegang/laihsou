package com.cherishTang.laishou.util.step.service;
...
import com.cherishTang.laishou.util.step.accelerometer.StepCount;
import com.cherishTang.laishou.util.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private void initNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtils.createNotificationChannel(false,false,
                    ConstantsHelper.stepChannelId,ConstantsHelper.stepChannelName,
                    NotificationManager.IMPORTANCE_LOW);
        }

        mBuilder = new NotificationCompat.Builder(this,ConstantsHelper.stepChannelId);
    ...
    private void initTodayData() {
        ...
        DbUtils.createDb(this, "LSStepCount");
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void remindNotify() {
        ...
        String plan = this.getSharedPreferences("share_date", Context.MODE_MULTI_PROCESS).getString("planWalk_QTY", "7000");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtils.createNotificationChannel(true,true,
                    ConstantsHelper.stepAlarmChannelId,ConstantsHelper.stepAlarmChannelName,
                    NotificationManager.IMPORTANCE_DEFAULT);
        }
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,ConstantsHelper.stepAlarmChannelId);
