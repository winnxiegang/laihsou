...
package com.cherishTang.laishou.zxing.decode;
...
import com.cherishTang.laishou.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(DecodeActivity activity,
		...
		decodeThread = new DecodeThread(activity, decodeFormats, baseHints,
				characterSet, new ViewfinderResultPointCallback(activity.getScannerView()));
		decodeThread.start();
	...
	public void handleMessage(Message message) {
		switch (message.what) {
			...
			case R.id.launch_product_query:
				...
				/**
				 * 这段代码是zxing项目组想要用	chrome打开浏览器浏览url
				 */
